...
exports.lastUpdatedBy = (lastUpdatedUser, data) => {
  return lastUpdatedUser === 'Mark Berridge' ? exports.userName(data) : lastUpdatedUser
}
...
exports.addHelpers = function (env) {
  ...
  env.addGlobal('lastUpdatedBy', exports.lastUpdatedBy)
}
