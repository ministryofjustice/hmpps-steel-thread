    ...
    'contactHistory': [
      {
        ...
        'timestamp': helpers.happeningIn({ daysLater: 35, atTime: '13:00' }),
        'session-date': helpers.happeningIn({ daysLater: 35 }),
      ...
      },
      {
        ...
        'type-of-session': 'Office visit',
        'lastUpdatedBy': 'Mark Berridge',
        'timestamp': helpers.happeningIn({ daysLater: 21, atTime: '13:00' }),
        'session-date': helpers.happeningIn({ daysLater: 21 }),
        'session-start-time': '1pm',
        'session-end-time': '1:30pm',
        'repeating': 'No, it’s a one-off session',
        'session-counts-towards-rar': 'No',
      ...
      },
      {
        ...
        'type-of-session': 'Office visit',
        'lastUpdatedBy': 'Mark Berridge',
        'timestamp': helpers.happeningIn({ daysLater: 7, atTime: '13:00' }),
        'session-date': helpers.happeningIn({ daysLater: 7 }),
        'session-start-time': '1pm',
        'session-end-time': '1:30pm',
        'repeating': 'No, it’s a one-off session',
        'session-counts-towards-rar': 'No',
